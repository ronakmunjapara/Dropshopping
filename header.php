...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-iBBXm8fW90+nuLcSKlbmrPcLa0OT92xO1BIsZ+ywDWZCvqsWgccV3gFoRBv0z+8dLJgyAHIhR35VZc2oM/gI1w==" crossorigin="anonymous" />    <!-- Custom stlylesheet -->
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <ul class="header-info">
                    <li>
                        <a href="wishlist.php"><i class="fas fa-store"></i></a>
                    </li>
